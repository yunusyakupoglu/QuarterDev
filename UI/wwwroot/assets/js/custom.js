...
$(".notification-dropdown .notification-scroll").mCustomScrollbar({
    advanced:{
    updateOnContentResize: true
    },
    theme: "minimal"
...
$('.notification-dropdown > .dropdown-menu, .message-dropdown > .dropdown-menu').click(function(e) {
    e.stopPropagation();
});
